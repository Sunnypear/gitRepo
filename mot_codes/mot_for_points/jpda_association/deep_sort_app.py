...
def create_detections(detection_mat, frame_idx, min_height=0):
    ...
    for row in detection_mat[mask]:
        ...
        #6： 置信度
        #7- ：特征
        bbox, confidence, feature = row[1:5], row[5], []
...
def run(sequence_dir, detection_file, output_file, min_confidence,
    ...
    def frame_callback(vis, frame_idx):
        ...
        # 进行轨迹合并
        wait_frames = 10
        # associated_frames_door = 1
        # if frame_idx % 2 ==0:
        #     tracker.consolidate_track_in_until_cur_frame_end_tracks()
        #     tracker.match_bet_new_and_end_track(frame_idx,wait_frames)
        ...
        # tracker.remove_fake_tracks()
        interval = 5
        track_episode_length = 10
        # if frame_idx == 400:
        #     print("s")
...
def parse_args():
    ...
    parser.add_argument("--sequence_dir", help="Path to MOTChallenge sequence directory",
        default=r'./silmulation_imgs/sequence1')
    # 自定义检测的路径
